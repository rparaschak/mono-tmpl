---
name: new-project
description: Initialize this monorepo template for a new project. Use only when the user explicitly asks for `new-project` and provides a project name. Replaces `{XXX}` placeholders inside `infrastructure/` with the given project name.
---
...
3. Report which infrastructure files changed.
